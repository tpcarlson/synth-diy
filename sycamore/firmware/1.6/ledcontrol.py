...
class LedControl:
    ...
    def blink(self, pin: pwmio.PWMOut):
        if pin == self.clockLed:
            ...
            # Clocks should be much more promptly updated
            self.clockLed.duty_cycle = self.ledButtonBrightness
    ...
    def setLoading(self) -> None:
        # L
        self.set7SegElement(0b00010000, 15, 0b00010000)
        self.set7SegElement(0b00001000, 14, 0b00001000)
        self.set7SegElement(0b00000100, 10, 0b00000100)

        # O
        self.set7SegElement(0b10000000, 0, 0b10000000)
        self.set7SegElement(0b01000000, 1, 0b01000000)
        self.set7SegElement(0b00100000, 2, 0b00100000)
        self.set7SegElement(0b00001000, 4, 0b00001000)
        self.set7SegElement(0b00000100, 5, 0b00000100)
        self.set7SegElement(0b00000001, 7, 0b00000001)
